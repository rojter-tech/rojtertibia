...
doPlayerSendTextMessage(cid, 18, 'You received mount from TibiaWS Shop.')
...
elseif getPlayerStorageValue(cid, 99+555884621212) == 1 then
doPlayerSendTextMessage(cid, 18, 'You received mount from TibiaWS Shop.')
doPlayerAddMount(cid, 40)
setPlayerStorageValue(cid, 99+555884621212, 2)
...
doPlayerSendTextMessage(cid, 18, 'You received addon full from TibiaWS Shop.')
