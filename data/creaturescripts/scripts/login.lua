...
registerCreatureEvent(cid, "recompensapoints")
registerCreatureEvent(cid, "ProtectLevel")
registerCreatureEvent(cid, "expvip")
registerCreatureEvent(cid, "FimVip")
registerCreatureEvent(cid, "VipDays")
registerCreatureEvent(cid, "VipReceive")
registerCreatureEvent(cid, "VocVIP")
registerCreatureEvent(cid, "recompensa")
registerCreatureEvent(cid, "recompensadoll")
registerCreatureEvent(cid, "recompensaa")
registerCreatureEvent(cid, "recompensaaa")
...
doPlayerPopupFYI(cid, "Welcome to Global InFiniTy.")

if isPlayer(cid) then
RegistrarIP(cid, item)
end
