local tilepos = {x=468, y=1358, z=10, stackpos=0}
local tilepos2 = {x=468, y=1358, z=10, stackpos=1}
local tilepos3 = {x=468, y=1358, z=10, stackpos=2}
...
if (item.uid == 10254 and item.itemid == 1945 and tile.itemid == 598) then
