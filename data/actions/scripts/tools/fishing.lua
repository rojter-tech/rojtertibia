...
--water elemental
local achou_nada = 30 -- chance.
local prob = 50 -- 1-100 range for prob. Quanto maior maior a chance de vir um item bom

local items = {
[10499] = {2238,2226,2148,2376,2509,2168,7588,7589,2152,2146,2149,2169,7632,7633,9811,9808,8764,10220}, }
function onUse(cid, item, fromPosition, itemEx, toPosition)

        if items[itemEx.itemid] ~= nil then
              if math.random(100) <= achou_nada then
