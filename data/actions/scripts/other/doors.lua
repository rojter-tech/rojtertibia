function onUse(cid, item, frompos, item2, topos)
	...
	if item.itemid == 12204 then
		doTransformItem(item.uid,1205)

	elseif item.itemid == 6904 then
		doTransformItem(item.uid,6903)

	elseif item.itemid == 6891 or item.itemid == 6892 then
		doTransformItem(item.uid,6893)

	elseif item.itemid == 6893 then
		doTransformItem(item.uid,6891)

	elseif item.itemid == 6894 then
		doTransformItem(item.uid,6895)

	elseif item.itemid == 6895 then
		doTransformItem(item.uid,6894)	

	elseif item.itemid == 7054 then
		doTransformItem(item.uid,7055)

	elseif item.itemid == 7055 then
		doTransformItem(item.uid,7054)	

	elseif item.itemid == 7056 then
		doTransformItem(item.uid,7057)

	elseif item.itemid == 7057 then
		doTransformItem(item.uid,7056)

	else
		return doorHandler:useDoor(item, topos, cid, nil, true)
