...
addTravelKeyword('edron', 'Do you seek a ride to Edron for |TRAVELCOST|?', 0, Position(33193, 31783, 3), nil, function(player) if player:getStorageValue(Storage.postman.Mission01) == 2 then player:setStorageValue(Storage.postman.Mission01, 3) end end)
