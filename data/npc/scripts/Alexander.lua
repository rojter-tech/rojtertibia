...
shopModule:addBuyableItem({'stone shower rune'}, 2288, 150, 4, 'stone shower rune')
shopModule:addBuyableItem({'thunderstorm rune'}, 2315, 150, 4, 'thunderstorm rune')
shopModule:addBuyableItem({'icicle rune'}, 2271, 150, 5, 'icicle rune')
shopModule:addBuyableItem({'holy missile rune'}, 2295, 80, 5, 'holy missile rune')
...
shopModule:addBuyableItem({'wild growth rune'}, 2269, 320, 2, 'wild growth rune')
