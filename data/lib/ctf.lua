...
if not captureTheFlag then
    ...
    captureTheFlag = {
        ...
        waitingRoom = Position(31432, 32741, 7),
		
		-- Death Room position -- MUDEI AQUI, PROBLEM?
        deathRoom = Position(31435, 32757, 7), 
 
        -- (Modify) Exit position,
        exit = Position(32344, 32224, 7),
        ...
        teams = {
            [CTF_TEAM_A] = {
                ...
                base = Position(31458, 32770, 6),
                -- (Modify) Flag, change position and actionid
                flag = Flag:new {position = Position(31461, 32770, 6), id = 8617, actionid = 15150, team = CTF_TEAM_A},
            ...
            [CTF_TEAM_B] = {
                ...
                -- (Modify) Base position (entrance)
                base = Position(31410, 32770, 6),
                -- (Modify) Flag, change position and actionid
                flag = Flag:new {position = Position(31407, 32770, 6), id = 8622, actionid = 15151, team = CTF_TEAM_B},
                -- How many players are in this team
                players = 0,
                -- How many points the team has scored so far
                score = 0
