<?php
	...
	$config['site_title'] = 'rOjter Tibia Server';
	$config['site_title_context'] = 'Shit is shit, and you are shit... :3';
	$config['site_url'] = "http://rojter.tech/tibia";
	...
	$config['sqlUser'] = 'rojtertibia';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = '';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'rojtertibia';

	// Hostname is usually localhost or 127.0.0.1.
	$config['sqlHost'] = '192.168.10.20';
